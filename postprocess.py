...
def process_actors(event):
    ...
    countries = ('ABW', 'AFG', 'AGO', 'AIA', 'ALA', 'ALB', 'AND', 'ARE', 'ARG',
                 ...
                 'RUS', 'RWA', 'SAU', 'SCG', 'SDN', 'SEN', 'SGP', 'SHN', 'SJM',
                 'SLB', 'SLE', 'SLV', 'SMR', 'SOM', 'SPM', 'SRB', 'SSD', 'STP',
                 'SUR', 'SVK', 'SVN', 'SWE', 'SWZ', 'SXM', 'SYC', 'SYR', 'TCA',
                 'TCD', 'TGO', 'THA', 'TJK', 'TKL', 'TKM', 'TLS', 'TON', 'TTO',
                 'TUN', 'TUR', 'TWN', 'TUV', 'TZA', 'UGA', 'UKR', 'URY', 'USA',
                 'UZB', 'VAT', 'VCT', 'VEN', 'VGB', 'VIR', 'VNM', 'VUT', 'WLF',
                 'WSM', 'YEM', 'ZAF', 'ZMB', 'ZWE', 'ATG', 'AUS')
...
def main(event_dict, this_date, file_details, server_details):
    ...
    runtime_dtg = '{:02d}-{:02d}-{:02d}-{:02d}-{:02d}-{:02d}'.format(runtime.year,
                                                  ...
                                                  runtime.minute,
                                                  runtime.second)
    filename = 'output/{}{}_{}.txt'.format(file_details.fullfile_stem, this_date, runtime_dtg)
